      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden" style={{
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-md">
            Create stunning resumes, analyze with ATS, and land your dream job with AI-powered insights.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold">AI-Powered Resume Builder</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold">ATS Score Analyzer</p>
                <p className="text-sm opacity-80">Optimize for applicant tracking systems</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-80">Get actionable improvement suggestions</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm font-semibold text-primary-500 hover:text-primary-600">
                  Forgot password?
                </a>
              </div>
