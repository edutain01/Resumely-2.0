  ...
  const handleImportResume = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setResumeTitle(importedData.personalInfo?.fullName || importedData.personalInfo?.name ? `${importedData.personalInfo.fullName || importedData.personalInfo.name}'s Resume` : 'Imported Resume')
